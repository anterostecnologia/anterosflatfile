...
public class Filler<G> implements br.com.anteros.flatfile.type.Filler {
	...
	/**
	 * @see br.com.anteros.flatfile.type#getPadding()
	 */
	public G getPadding() {
		return padding;
	}
	...
	/**
	 * @see br.com.anteros.flatfile.type#setPadding(G)
	 */
	public void setPadding(G fillWith) {

		if (ObjectUtils.isNotNull(fillWith)) {
	...
	/**
	 * @see br.com.anteros.flatfile.type#getSideToFill()
	 */
	...
	/**
	 * @see br.com.anteros.flatfile.type#setSideToFill(br.com.anteros.flatfile.type.component.jrimum.texgit.type.component.Side)
	 */
	public void setSideToFill(Side sideToFill) {

		if (ObjectUtils.isNotNull(sideToFill)) {
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(java.lang.String,
	 *      int)
	 */
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(long,
	 *      int)
	 */
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(int,
	 *      int)
	 */
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(short,
	 *      int)
	 */
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(byte,
	 *      int)
	 */
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(char,
	 *      int)
	 */
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(double,
	 *      int)
	 */
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(float,
	 *      int)
	 */
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(java.lang.Object,
	 *      int)
	 */
	public String fill(Object tofill, int length) {
		...
		if (ObjectUtils.isNotNull(tofill)) {
	...
	/**
	 * @see br.com.anteros.flatfile.type#fill(br.com.anteros.flatfile.TextStream,
	 *      int)
	 */
	...
	public String toString() {
		...
		return format("Filler [padding=\"%s\", sideToFill=%s]", ObjectUtils.whenNull(this.padding, StringUtils.EMPTY),
				ObjectUtils.whenNull(this.sideToFill, StringUtils.EMPTY));
	}
